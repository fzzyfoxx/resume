...
if angle_input_rand_range is not None:
    cfg.angle_input_rand_range = bool(angle_input_rand_range)
...
dg = DatasetGenerator(map_generator=msmg,
                      ...
                      **msmg_config['dg'],
                      ...
                      preprocess_funcs=[(blur_img, {'blur_ratio_range': (0.1, 0.6), 'kernel_size': 3, 'color_rand_range': 0.1}, True),
                                        (op_rotated_enc_full_label, {'angle_samples_num': cfg.angle_samples_num, 'random_angle_weight': cfg.random_angle_weight, 'rotated_bbox_label': cfg.rotated_bbox_label, 'angle_input_rand_range': cfg.angle_input_rand_range}, True)]
                      )
