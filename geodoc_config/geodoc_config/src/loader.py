...
def load_service_mapping():
    """
    Loads the service mapping configuration.
...
def get_service_config(service_name, key):
    """
    Get the configuration for a specific service and key (service functionality).

    Args:
        service_name (str): The name of the service.
        key (str): The key representing the service functionality.
    Returns:
        dict: The loaded configuration data for the specified service and key, or None if not found
    """
